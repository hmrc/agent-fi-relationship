...
package object controllers {
  ...
  val validTestRelationshipCesa: Relationship = Relationship(Arn(validTestArn), testService, validTestNINO, Terminated, LocalDateTime.parse(testResponseDate), None, fromCesa = true)
