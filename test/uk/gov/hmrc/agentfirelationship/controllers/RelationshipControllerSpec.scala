...
class RelationshipControllerSpec
  ...
  "RelationshipController" should {
    ...
    "return Status: CREATED for creating new record as a client" in {
      ...
      when(mockAuditService.sendCreateRelationshipEvent(any())(any(), any()))
    ...
    "send an audit event if the relationship is successfully created" in {
      ...
      verify(mockAuditService, times(1))
        .sendCreateRelationshipEvent(any())(any(), any())
      verify(mockMongoService, times(1)).findRelationships(any(),
                                                           any(),
                                                           any(),
                                                           any())(any())
    ...
    "return Status: OK for deleting a record as a client" in {
      ...
      when(
        mockAuditService.sendTerminatedRelationshipEvent(any())(any(), any()))
        .thenReturn(Future successful (()))
    ...
    "return Status: OK for deleting a record as hmrc" in {
      ...
      when(
        mockAuditService.sendHmrcLedDeleteRelationshipAuditEvent(any())(any(),
                                                                        any()))
        .thenReturn(Future successful (()))
    ...
    "send an audit event if the relationship is successfully deleting" in {
      ...
      await(response)
      verify(mockAuditService, times(1))
        .sendTerminatedRelationshipEvent(any())(any(), any())
    }
