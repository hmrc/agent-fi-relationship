...
package uk.gov.hmrc.agentfirelationship.controllers.models

import uk.gov.hmrc.agentfirelationship.models.{ EnrolmentAsAgent, EnrolmentMtdIt, EnrolmentMtdVat, TypeOfEnrolment }
